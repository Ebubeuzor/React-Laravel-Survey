...
class SurveyController extends Controller
{
    ...
    public function store(SurveyStoreRequest $request)
    {
        ...
        // Convert any arrays in $data to JSON format
    ...
    public function update(SurveyUpdateRequest $request, Survey $survey)
    {
        ...
        //check if image was given and save an localfile system
        if (isset($data['image'])) {
            $relativePath = $this->saveImage($data['image']);
            $data['image'] = $relativePath;
        ...
        // Get ids as plain array of the questions
    ...
    public function destroy(Request $request, Survey $survey)
    {
        ...
        //if therebis an old image, delete it
        if ($survey->image) {
            $absolutePath = public_path($survey->image);
            File::delete($absolutePath);
        }
